		...
		<div class="">
			...
			<div class="row">
						...
						<div class="navbar navbar-default" role="navigation">
							...
							<div class="navbar-collapse collapse sidebar-navbar-collapse">
								<ul class="nav navbar-nav">
									...
									<li class="active"><a <?php echo "href=\"./studentSchedule.php?course=" . $course . "\""; ?>>Schedule</a></li>
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-12">
							<h4 style="padding-left:5%;color:#A0522D;">Course Schedule</h4>
						</div>
						<div class="row" style="padding-left:2%;">
							<div class="col-sm-10">
								<?php
									$syllabus = file_get_contents("../../lectures/" . $course ."/schedule.txt");
									echo "<pre>" . utf8_decode($syllabus) . "</pre>";
								?>
							</div>
						</div>
					</div>
