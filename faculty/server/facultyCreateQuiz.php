<?php
	...
	else
	{
		...
		$query = "insert into quiz ( course_code, quiz_name, enable, time_period, question_order, due_date ) values ('$course_code','$quiz_name', '$enable' , $time_period, '$qstn_order', '$due_date $due_time:00' )";
		mysql_query($query);
