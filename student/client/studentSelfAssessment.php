...
<html>
	...
	<body style="padding-top:50px;">
		...
		<div class="">
			...
			<div class="row">
						...
						<div class="navbar navbar-default" role="navigation">
							...
							<div class="navbar-collapse collapse sidebar-navbar-collapse">
								<ul class="nav navbar-nav">
									...
									<li class="active"><a <?php echo "href=\"./studentSelfAssessment.php?course=" . $course . "\""; ?> >Self Assessments</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-10">
					<div class="row">
						<div class="col-sm-7">
							<center><h4>Self Assessment Quiz</h4></center>
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-sm-5">
							<input type="text" id="qstn_summary" class="form-control" placeholder = "Enter topic name" autocomplete="off" data-provide="typeahead" data-items="20"/>
						</div>
						<div class="col-sm-5">
							<div style="padding-top:2%;color:red;" id = "topic_msg"></div>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-sm-2">
							<label style="padding-top:3%;">Number of questions</label>
						</div>
						<div class="col-sm-5">
							<input type="number" class="form-control" min = "1" placeholder = "Enter number of questions" id="no_qstns" />
						</div>
						<div class="col-sm-5">
							<div style="padding-top:2%;color:red;" id = "qstns_msg"></div>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-sm-2">
							<label style="padding-top:3%;">Duration ( in mins )</label>
						</div>
						<div class="col-sm-5">
							<input type="number" class="form-control" min = "1" placeholder = "Enter quiz duration in minutes" id = "quiz_duration" />
						</div>
						<div class="col-sm-5">
							<div style="padding-top:2%;color:red;" id = "duration_msg"></div>
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-sm-5">
							<div class="row">
								<div class="col-sm-3">
									<label><input type = "radio" name="level" id = "easy"/> Easy</label>
								</div>
								<div class="col-sm-3">
									<label><input type = "radio" name="level" id="medium" /> Medium</label>
								</div>
								<div class="col-sm-3">
									<label><input type = "radio" name="level" id="difficult" /> Difficult</label>
								</div>
								<div class="col-sm-3">
									<label><input type = "radio" name="level" id="mixed" /> Mixed</label>
								</div>
							</div>
						</div>
						<div class="col-sm-5">
							<div style="color:red;" id = "difficulty_msg"></div>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-sm-7">
							<center><button class="btn btn-success" onclick="start_quiz();">Start Quiz</button></center>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript" src = "./js/studentSelfAssessment.js"></script>
	</body>
</html>
